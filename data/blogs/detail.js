const blogDetail = [
  ...
  },
  {
    ...
    date: "2 Feb 2024",
    tags: ["Node.js", "Basic Node server", "Express.js", "Node.js + Express"],
    slug: "simple-server-using-nodejs-express",
    meta: {
      title: "How to set up a simple server using Node.js and Express",
      description:
        "this blog is a setup for a basic server using node.js and Express.",
      image:
        "https://res.cloudinary.com/dhntmsget/image/upload/v1706768200/blog-demo/250X250.png",
      url: "https://poojan-bhalodiya.vercel.app/blog/simple-server-using-nodejs-express",
      keywords: [
        "Node.js",
        "Basic Node server",
        "Express.js",
